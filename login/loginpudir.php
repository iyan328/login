...
if($c['hak_akses']=="pudir"){
header("location:../Pudir/homepudir.php");
}else{
	?>
	<script type="text/javascript">
alert("username/password yang anda masukkan salah, silahkan masukkan username/password yang benar");document.location='../Pudir/login.php'</script>
<?php
}
}else{
	?>
