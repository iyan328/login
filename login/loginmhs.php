...
if($c['hak_akses']=="mahasiswa"){
header("location:../Mhs/mahasiswa.php");
}else{
	?>
	<script type="text/javascript">
alert("username/password yang anda masukkan salah, silahkan masukkan username/password yang benar");document.location='../mhs/index.html'</script>
<?php
}
