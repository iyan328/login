...
if($c['hak_akses']=="koordinator"){
header("location:../Koordinator/homek.php");
}else{
	?>
	<script type="text/javascript">
alert("username/password yang anda masukkan salah, silahkan masukkan username/password yang benar");document.location='../Koordinator/index.html'</script>
<?php
}
}else{
	?>
...
header("location:../Koordinator/index.html");
}
?>