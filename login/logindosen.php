...
if($c['hak_akses']=="dosenpembimbing"){
header("location:../DosenP/homedosen.php");
}else{
	?>
	<script type="text/javascript">
alert("username/password yang anda masukkan salah, silahkan masukkan username/password yang benar");document.location='../DosenP/login.php'</script>
<?php
}
}else{
	?>
